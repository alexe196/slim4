            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xlg-3">
                        <!-- Column -->
                        <div class="card">
                            <img class="card-img-top" src="/public/assets/images/background/profile-bg.jpg"
                                 alt="Card image cap">
                                ...
                                <div class="message-box contact-box">
                                    ...
                                    <div class="message-widget contact-widget">
                                        ...
                                        <a href="#" class="d-flex align-items-center">
                                            <div class="user-img mb-0"> <img src="/public/assets/images/users/1.jpg"
                                        ...
                                        <!-- Message -->
                                        <a href="#" class="d-flex align-items-center">
                                            <div class="user-img mb-0"> <img src="/public/assets/images/users/2.jpg"
                                                                             alt="user" class="img-circle"> <span
                                        ...
                                        <!-- Message -->
                                        <a href="#" class="d-flex align-items-center">
                                            <div class="user-img mb-0"> <img src="/public/assets/images/users/4.jpg"
                                                                             alt="user" class="img-circle"> <span
                                ...
                                <div class="tab-pane active" id="home" role="tabpanel">
                                    <div class="card-body">
                                        <div class="profiletimeline border-start-0">
                                            <div class="sl-item">
                                                <div class="sl-left"> <img src="/public/assets/images/users/1.jpg" alt="user"
                                                    ...
                                                    <div><a href="#" class="link">John Doe</a> <span class="sl-date">5
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-6 mb-3"><img
                                                                        src="/public/assets/images/big/img1.jpg" alt="user"
                                                                        class="img-responsive radius w-100"></div>
                                                            <div class="col-lg-3 col-md-6 mb-3"><img
                                                                        src="/public/assets/images/big/img2.jpg" alt="user"
                                                                        class="img-responsive radius w-100"></div>
                                                            <div class="col-lg-3 col-md-6 mb-3"><img
                                                                        src="/public/assets/images/big/img3.jpg" alt="user"
                                                                        class="img-responsive radius w-100"></div>
                                                            <div class="col-lg-3 col-md-6 mb-3"><img
                                                                        src="/public/assets/images/big/img4.jpg" alt="user"
                                                                        class="img-responsive radius w-100"></div>
                                                        </div>
                                            ...
                                            <hr>
                                            <div class="sl-item">
                                                <div class="sl-left"> <img src="/public/assets/images/users/2.jpg" alt="user"
                                                                           class="img-circle"> </div>
                                                <div class="sl-right">
                                                    <div> <a href="#" class="link">John Doe</a> <span class="sl-date">5
                                                            minutes ago</span>
                                            ...
                                            <hr>
                                            <div class="sl-item">
                                                <div class="sl-left"> <img src="/public/assets/images/users/3.jpg" alt="user"
                                                                           class="img-circle"> </div>
                                                <div class="sl-right">
                                                    <div><a href="#" class="link">John Doe</a> <span class="sl-date">5
                                                            minutes ago</span>
                                            ...
                                            <hr>
                                            <div class="sl-item">
                                                <div class="sl-left"> <img src="/public/assets/images/users/4.jpg" alt="user"
                                                                           class="img-circle"> </div>
                                                <div class="sl-right">
                                                    <div><a href="#" class="link">John Doe</a> <span class="sl-date">5
                                                            minutes ago</span>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OpenServer\domains\slim.loc\resources\views/index.blade.php ENDPATH**/ ?>